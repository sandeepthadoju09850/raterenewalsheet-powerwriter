...
public class Log {
	...
	public void setTcStartTime() {
		tcStartTime = Libraries.ap.automation.common.framework.Util
				.getDateStamp(Libraries.ap.automation.common.framework.Util.ISO8601_DATETIMESTAMP);
	}
	...
	public void setTcEndTime() {
		tcEndTime = Libraries.ap.automation.common.framework.Util
				.getDateStamp(Libraries.ap.automation.common.framework.Util.ISO8601_DATETIMESTAMP);
	}
	...
	public void logSeStep(String step) {
		// get current date
		String timeStamp = Libraries.ap.automation.common.framework.Util
				.getDateStamp(Libraries.ap.automation.common.framework.Util.ISO8601_TIMESTAMP);
	...
	public void logTestStep(String step) {
		// get current date
		String timeStamp = Libraries.ap.automation.common.framework.Util.getDateStamp(Libraries.ap.automation.common.framework.Util.ISO8601_TIMESTAMP);
		testStepLogger(step);
