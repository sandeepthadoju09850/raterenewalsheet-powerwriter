...
public class TC12_PA_TCRegression extends BaseTest{
	...
	public static void TC12_PA_TCRegressionMethod(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,String strRegressionName, File file,XSSFWorkbook workbook, ExtentTest test) throws IOException {
		{
			...
			try {
				...
				e.printStackTrace();
				se.verify().verifyEquals("TC06_IL_TCRegression test  failed", true, false, true, test);
