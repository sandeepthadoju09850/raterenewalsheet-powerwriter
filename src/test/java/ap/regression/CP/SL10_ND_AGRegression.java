...
public class SL10_ND_AGRegression extends BaseTest{
	...
	public static void SL10_ND_AGRegressionMethod(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,String strRegressionName, File file,XSSFWorkbook workbook, ExtentTest test) throws IOException 
	{
		...
		CP_ScheduledProperty CP_ScheduledProperty = TestPageFactory.initElements(se, CP_ScheduledProperty.class);
			...
			while (iteration < table.size()) {
				...
				if (transactionsList.contains("RedoNewQuote")) {
					...
					//BT.NavigateToTabs("Additional Coverage Parts",test);
			...
			e.printStackTrace();
			se.verify().verifyEquals("SL10_ND_SLRegression test  failed", true, false, true, test);
