...
public class Functional_03_SL_MelissaLookupNoMatch extends BaseTest{
	...
	public static void SL_MelissaLookupNoMatch(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,String strRegressionName, File file,XSSFWorkbook workbook, ExtentTest test) throws IOException {
		{
			...
			try {
				...
				while (iteration < table.size()) {
					...
					if (transactionsList.contains("NewQuote1")) {
						...
						BT.ClickContinue(test); //Liability Classes
				...
				e.printStackTrace();
				se.verify().verifyEquals("Functional_03_SL_MelissaLookupNoMatch test failed", true, false, true, test);
