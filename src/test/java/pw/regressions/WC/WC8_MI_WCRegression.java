...
public class WC8_MI_WCRegression extends BaseTest {
	ExtentReports extent;
	ExtentTest test;
	public static void MI_WCRegressionMethod(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,File file,XSSFWorkbook workbook, ExtentTest test) throws IOException {
		...
		try {
			...
			if (transactionsList.contains("NewQuote")) {
				...
				CommonMethods.NavigateTo("Michigan", test);
			...
			e.printStackTrace();
			se.verify().verifyEquals("MI WC Regression test  failed", true, false);
			testTearDown(se);
		}
	}
}
