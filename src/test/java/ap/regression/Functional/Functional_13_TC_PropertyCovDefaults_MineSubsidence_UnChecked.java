...
public class Functional_13_TC_PropertyCovDefaults_MineSubsidence_UnChecked extends BaseTest{
	...
	public static void TC_PropertyCovDefaults_MineSubsidence_UnChecked(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,String strRegressionName, File file,XSSFWorkbook workbook, ExtentTest test) throws IOException {
		{
			...
			try {
				...
				e.printStackTrace();
				se.verify().verifyEquals("Functional_13_TC_PropertyCovDefaults_MineSubsidence_UnChecked test failed", true, false, true, test);
