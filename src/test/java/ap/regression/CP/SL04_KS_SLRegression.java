...
public class SL04_KS_SLRegression extends BaseTest{
	...
	public static void SL04_KS_SLRegressionMethod(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,String strRegressionName, File file,XSSFWorkbook workbook, ExtentTest test) throws IOException 
	{
		...
		CP_ScheduledProperty CP_ScheduledProperty = TestPageFactory.initElements(se, CP_ScheduledProperty.class);
			...
			e.printStackTrace();
			se.verify().verifyEquals("SL04_KS_SLRegression test  failed", true, false, true, test);
