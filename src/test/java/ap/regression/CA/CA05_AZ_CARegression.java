...
public class CA05_AZ_CARegression extends BaseTest{
	...
	public static void CA05_AZ_CARegressionMethod(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,String strRegressionName, File file,XSSFWorkbook workbook, ExtentTest test) throws IOException {
		{
			...
			try {
				...
				while (iteration < table.size()) {
					...
					if (transactionsList.contains("NewQuote")) {
						...
						CA_IndividualSchedule.CA_IndividualSchedule_Details(strRegressionID, transaction, suspendSheet, test);
						...
						CA_BusinessInterruption.CA_BusinessInterruptionDetails(strRegressionID, transaction, suspendSheet, test);
					   CA_Garagekeepers.CA_Garagekeepers_Details(strRegressionID, transaction, suspendSheet, test);
				...
				e.printStackTrace();
				se.verify().verifyEquals("CA05_AZ_CARegression test failed", true, false, true, test);
