...
public class Functional_24_TC_ISO_ExactMatch_ExtUser extends BaseTest{
	...
	public static void TC_ISO_ExactMatch_ExtUser(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,String strRegressionName, File file,XSSFWorkbook workbook, ExtentTest test) throws IOException {
		{
			...
			try {
				...
				e.printStackTrace();
				se.verify().verifyEquals("Functional_24_TC_ISO_ExactMatch_ExtUser test failed", true, false, true, test);
