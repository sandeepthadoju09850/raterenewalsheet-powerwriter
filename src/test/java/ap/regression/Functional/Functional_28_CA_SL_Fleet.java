...
public class Functional_28_CA_SL_Fleet extends BaseTest{
	...
	public static void CA_SL_Fleet(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,String strRegressionName, File file,XSSFWorkbook workbook, ExtentTest test) throws IOException {
		{
			...
			try {
				...
				while (iteration < table.size()) {
					...
					if (transactionsList.contains("VerifyPolicyInPW")) {
						...
						APPW_CommonMethods.getverifyFleetinPW(transaction, "Check", test);
				...
				e.printStackTrace();
				se.verify().verifyEquals("Functional_28_CA_SL_Fleet test failed", true, false, true, test);
