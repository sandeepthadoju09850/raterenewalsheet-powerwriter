...
public class CU14_KY_CURegression extends BaseTest{
	...
	public static void CU14_KY_CURegressionMethod(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,String strRegressionName, File file,XSSFWorkbook workbook, ExtentTest test) throws IOException 
	{
		...
		try {
			...
			String strRegressionIDUnderlined = "CUBP_16";
			...
			// UNDERLYING POLICY 1 CUBP_16 NEW QUOTE TRANSACTION
			...
			strRegressionIDUnderlined = "CUCA_13";
			...
			strRegressionIDUnderlined = "CUWC_13";
			if (transactionsList.contains("NewQuote")) {
				transaction = "NewQuote";String suspendSheet = ExcelOperations.getPageToBeSuspended(strRegressionID,transaction);
				//LoginPage.APAppLogin(strRegressionIDUnderlined,   transaction,"No", test);
				APPW_CommonMethods.openQuoteInAP(quote,"N/A",test);
			...
			// COMMERCIAL UMBRELLA CU_14 NEW QUOTE TRANSACTION
			...
			if (transactionsList.contains("BookPolicyInPW")) {
				strRegressionIDUnderlined = "CUBP_16";
				LoginPage.APAppLogin(strRegressionIDUnderlined,   transaction,"No", test);
			...
			e.printStackTrace();
			se.verify().verifyEquals("CU14_KY_CURegression test  failed", true, false, true, test);
