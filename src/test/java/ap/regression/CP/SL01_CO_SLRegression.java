...
public class SL01_CO_SLRegression extends BaseTest{
	...
	public static void SL01_CO_SLRegressionMethod(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,String strRegressionName, File file,XSSFWorkbook workbook, ExtentTest test) throws IOException 
	{
		...
		try {
			...
			e.printStackTrace();
			se.verify().verifyEquals("SL01_CO_SLRegression test  failed", true, false, true, test);
