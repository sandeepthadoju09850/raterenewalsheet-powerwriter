...
public class CA07_PA_SLRegression extends BaseTest{
	...
	public static void CASL07_PA_RegressionMethod(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,String strRegressionName, File file,XSSFWorkbook workbook, ExtentTest test) throws IOException {
		{
			...
			try {
				...
				String strRegressionIDUnderlined = "CASL_07";
				...
				List<Map<String, String>> table = ExcelOperations.getPagesData(constants.loginPageName, strRegressionID,transaction);
					...
					strRegressionIDUnderlined = "CA_07";
					if (transactionsList.contains("NewQuote")) {
						transaction = "NewQuote";
				...
				e.printStackTrace();
				se.verify().verifyEquals("CA07_PA_SLRegression test  failed", true, false, true, test);
