...
public class CP11_ND_CPRegression extends BaseTest {
	ExtentReports extent;
	ExtentTest test;
	
	public static void NDCpRegressionMethod(Browsers myBrowser, SeHelper se, Map<String, Object> params,
		...
		try {		
			...
			e.printStackTrace();
			se.verify().verifyEquals("ND CP Regression test  failed", true, false);
			testTearDown(se);
		}
	}
