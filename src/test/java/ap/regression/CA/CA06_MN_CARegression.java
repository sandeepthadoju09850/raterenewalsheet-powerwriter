...
public class CA06_MN_CARegression extends BaseTest{
	...
	public static void CA06_MN_CARegressionMethod(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,String strRegressionName, File file,XSSFWorkbook workbook, ExtentTest test) throws IOException {
		{
			...
			try {
				...
				e.printStackTrace();
				se.verify().verifyEquals("CA06_MN_CARegression test failed", true, false, true, test);
