...
public class CU06_IA_CURegression extends BaseTest{
	...
	public static void CU06_IA_CURegressionMethod(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,String strRegressionName, File file,XSSFWorkbook workbook, ExtentTest test) throws IOException 
	{
		...
		try {
			...
			String strRegressionIDUnderlined = "CUSL_07";
			...
			// Booking Underlying Quote (IA SL) in PW
			...
			// Policy Issuance of Underlying Quote (IA SL)
			...
			e.printStackTrace();
			se.verify().verifyEquals("CU06_IA_CURegression test  failed", true, false, true, test);
