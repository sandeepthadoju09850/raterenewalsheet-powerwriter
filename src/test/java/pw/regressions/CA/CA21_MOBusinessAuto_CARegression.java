...
public class CA21_MOBusinessAuto_CARegression extends BaseTest {
	ExtentReports extent;
	ExtentTest test;

	public static void MOBusinessAuto_CARegressionMethod(Browsers myBrowser, SeHelper se, Map<String, Object> params,
		...
		CA_MiscellaneousOptions CA_MiscellaneousOptions = TestPageFactory.initElements(se, CA_MiscellaneousOptions.class);
		...
		try {
			...
			if (transactionsList.contains("NewQuote")) {
				...
				CommonMethods.NavigateTo("Miscellaneous Options",test);
				CA_MiscellaneousOptions.MiscellaneousOptions(strRegressionID, transaction, suspendSheet, test);
			...
			e.printStackTrace();
			se.verify().verifyEquals("M0_BusinessAutoDealersCARegression test  failed", true, false);
			testTearDown(se);
		}
	}
