...
public class BP14_AZ_BPRegression extends BaseTest{
	...
	public static void BP14_AZ_BPRegressionMethod(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,String strRegressionName, File file,XSSFWorkbook workbook, ExtentTest test) throws IOException {
		{
			...
			try {
				...
				e.printStackTrace();
				se.verify().verifyEquals("BP_14_AZ_BPRegression test  failed", true, false, true, test);
