...
public class Functional_05_SL_GLClassDefaults_TreePruning extends BaseTest{
	...
	public static void SL_GLClassDefaults_TreePruning(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,String strRegressionName, File file,XSSFWorkbook workbook, ExtentTest test) throws IOException {
		{
			...
			try {
				...
				e.printStackTrace();
				se.verify().verifyEquals("Functional_05_SL_GLClassDefaults_TreePruning test failed", true, false, true, test);
