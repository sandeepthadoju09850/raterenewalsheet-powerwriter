...
public class WC01_WI_WCRegression extends BaseTest {
	...
	public static void WC01_WI_WCRegressionMethod(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,String strRegressionName, File file,XSSFWorkbook workbook, ExtentTest test) throws IOException {
		{
			...
			try {
				...
				e.printStackTrace();
				se.verify().verifyEquals("WC01_WI_WCRegression test  failed", true, false, true, test);
