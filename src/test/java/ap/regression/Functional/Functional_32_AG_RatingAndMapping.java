...
public class Functional_32_AG_RatingAndMapping extends BaseTest{
	ExtentReports extent;
	ExtentTest test;
	static String quote;

	@SuppressWarnings("unused")
	public static void AG_RatingAndMapping(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,String strRegressionName, File file,XSSFWorkbook workbook, ExtentTest test) throws IOException {
		{
			...
			try {
				...
				e.printStackTrace();
				se.verify().verifyEquals("Functional_32_AG_RatingAndMapping test failed", true, false, true, test);
