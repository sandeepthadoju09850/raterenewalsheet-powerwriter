...
public class SL05_ND_SLRegression extends BaseTest{
	...
	public static void SL05_ND_SLRegressionMethod(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,String strRegressionName, File file,XSSFWorkbook workbook, ExtentTest test) throws IOException 
	{
		...
		CP_ScheduledProperty CP_ScheduledProperty = TestPageFactory.initElements(se, CP_ScheduledProperty.class);
			...
			e.printStackTrace();
			se.verify().verifyEquals("SL05_ND_SLRegression test  failed", true, false, true, test);
