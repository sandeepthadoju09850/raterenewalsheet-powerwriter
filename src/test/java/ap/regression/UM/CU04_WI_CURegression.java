...
public class CU04_WI_CURegression extends BaseTest{
	...
	public static void CU04_WI_CURegressionMethod(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,String strRegressionName, File file,XSSFWorkbook workbook, ExtentTest test) throws IOException 
	{
		...
		try {
			...
			String strRegressionIDUnderlined = "CUTC_08";
			...
			if (transactionsList.contains("NewQuote")) {
				...
				CP_ExtendedNamedInsured.CP_ExtendedNamedInsured_Details(strRegressionIDUnderlined, transaction, suspendSheet, strAgentLinkTC,strLOB,strRelease_SelectRelease,strRole_SelectRoleAs, test);
			...
			// UNDERLYING POLICY 2 CUCA_02 - CA 2 
			strRegressionIDUnderlined = "CUCA_02";
			...
			strRegressionIDUnderlined = "CUWC_01";
			if (transactionsList.contains("NewQuote")) {
				transaction = "NewQuote";String suspendSheet = ExcelOperations.getPageToBeSuspended(strRegressionID,transaction);
				APPW_CommonMethods.openAccountDetails(test);
			...
			if (transactionsList.contains("BookPolicyInPW")) {
				strRegressionIDUnderlined = "CUTC_08";
				LoginPage.APAppLogin(strRegressionIDUnderlined,   transaction,"No", test);
			...
			e.printStackTrace();
			se.verify().verifyEquals("CU04_WI_CURegression test  failed", true, false, true, test);
