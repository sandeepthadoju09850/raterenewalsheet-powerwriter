...
public class CA01_MI_TCRegression  extends BaseTest{
	...
	public static void CATC01_MI_RegressionMethod(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,String strRegressionName, File file,XSSFWorkbook workbook, ExtentTest test) throws IOException {
		{
			...
			try {
				...
				String strRegressionIDUnderlined = "CATC_01";
				...
				List<Map<String, String>> table = ExcelOperations.getPagesData(constants.loginPageName, strRegressionID,transaction);
					...
					strRegressionIDUnderlined = "CA_01";
					if (transactionsList.contains("NewQuote")) {
				...
				e.printStackTrace();
				se.verify().verifyEquals("CA01_MI_TCRegression test  failed", true, false, true, test);
