...
public class TC05_CO_TCRegression extends BaseTest{
	...
	public static void TC05_CO_TCRegressionMethod(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,String strRegressionName, File file,XSSFWorkbook workbook, ExtentTest test) throws IOException {
		{
			...
			try {
				...
				e.printStackTrace();
				se.verify().verifyEquals("TC_05_CO_TCRegression test  failed", true, false, true, test);
