...
public class CP_PropertyAdditionalInterests extends OR_CP {
	public void CP_PropertyAdditionalInterests_Details(String strRegressionID, String transaction,String suspendSheet,  ExtentTest test) throws IOException
	{
		...
		List<Map<String, String>> table = ExcelOperations.getPagesData(constants.Property_Additional_Interests, strRegressionID, transaction);
	int iteration = 0;
