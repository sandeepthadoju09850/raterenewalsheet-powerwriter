...
public class CU17_IA_CURegression extends BaseTest{
	...
	public static void CU17_IA_CURegressionMethod(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,String strRegressionName, File file,XSSFWorkbook workbook, ExtentTest test) throws IOException 
	{
		...
		try {
			...
			String strRegressionIDUnderlined = "CUSL_09";
			...
			// UNDERLYING POLICY 1 CUSL_09 NEW QUOTE TRANSACTION
		...
		if (transactionsList.contains("NewQuote")) {
			...
			// UNDERLYING POLICY 1 CUSL_09 REDO NEW QUOTE TRANSACTION
			...
			// UNDERLYING POLICY 2 CUWC_15 
			strRegressionIDUnderlined = "CUWC_15";
			if (transactionsList.contains("NewQuote")) {
				transaction = "NewQuote";String suspendSheet = ExcelOperations.getPageToBeSuspended(strRegressionID,transaction);
			...
			// Booking Underlying Quote (AG IA) in PW
					...
					if (transactionsList.contains("BookPolicyInPW")) {
						...
						strRegressionIDUnderlined = "CUSL_09";
						LoginPage.APAppLogin(strRegressionIDUnderlined,   transaction,"No", test);
			...
			e.printStackTrace();
			se.verify().verifyEquals("CU17_IA_CURegression test  failed", true, false, true, test);
