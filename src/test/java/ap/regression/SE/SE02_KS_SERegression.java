...
public class SE02_KS_SERegression extends BaseTest{
	...
	public static void SE02_KS_SERegressionMethod(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,String strRegressionName, File file,XSSFWorkbook workbook, ExtentTest test) throws IOException 
	{
		...
		try {
			...
			e.printStackTrace();
			se.verify().verifyEquals("SE02_KS_SERegression test  failed", true, false, test);
