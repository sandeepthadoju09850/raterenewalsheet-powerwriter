...
public class CP_Liablitycoverages extends BL_OR_CP {
	public void CP_Liablitycoverages_Details(String strRegressionID, String transaction,String suspendSheet,  ExtentTest test) throws IOException
	{
		...
		List<Map<String, String>> table = ExcelOperations.getBLPagesData(constants.Liability_Coverages, strRegressionID, transaction);
		int iteration = 0;
