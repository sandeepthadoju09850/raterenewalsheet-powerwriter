...
public class CA26_NDBusinessAuto_CARegression extends BaseTest{

	ExtentReports extent;
	ExtentTest test;
		
	public static void NDBusinessAuto_CARegressionMethod(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,File file,XSSFWorkbook workbook, ExtentTest test) throws IOException {
		...
		CA_DriveOtherCar CA_DriveOtherCarPage = TestPageFactory.initElements(se, CA_DriveOtherCar.class);
		...
		try {
			...
			if (transactionsList.contains("NewQuote")) {
				...
				CA_DriveOtherCarPage.DriveOtherCar(strRegressionID, transaction, suspendSheet, test);
			...
			e.printStackTrace();
			se.verify().verifyEquals("NDBusinessAutoRegression test  failed", true, false);
			testTearDown(se);
		}
	}
