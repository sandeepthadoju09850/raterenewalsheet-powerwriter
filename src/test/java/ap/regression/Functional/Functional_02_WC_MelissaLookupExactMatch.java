...
public class Functional_02_WC_MelissaLookupExactMatch extends BaseTest{
	...
	public static void WC_MelissaLookupExactMatch(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,String strRegressionName, File file,XSSFWorkbook workbook, ExtentTest test) throws IOException {
		{
			...
			try {
				...
				e.printStackTrace();
				se.verify().verifyEquals("Functional_02_MelissaLookupExactMatch test failed", true, false, true, test);
