...
public class Functional_04_SL_GLClassDefaults_PestControl extends BaseTest{
	...
	public static void SL_GLClassDefaults_PestControl(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,String strRegressionName, File file,XSSFWorkbook workbook, ExtentTest test) throws IOException {
		{
			...
			try {
				...
				e.printStackTrace();
				se.verify().verifyEquals("Functional_04_SL_GLClassDefaults_PestControl failed", true, false, true, test);
