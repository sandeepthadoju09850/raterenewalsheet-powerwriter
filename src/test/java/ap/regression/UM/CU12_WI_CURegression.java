...
public class CU12_WI_CURegression extends BaseTest{
	...
	public static void CU12_WI_CURegressionMethod(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,String strRegressionName, File file,XSSFWorkbook workbook, ExtentTest test) throws IOException 
	{
		...
		try {
			...
			String strRegressionIDUnderlined = "CUBP_14";
			...
			// UNDERLYING POLICY 1 CUBP_14 NEW QUOTE TRANSACTION
			 ...
			 // UNDERLYING POLICY 1 CUBP_14 REDO TRANSACTION
			...
			// UNDERLYING POLICY 2 CUCA_11 NEW QUOTE TRANSACTION
			strRegressionIDUnderlined = "CUCA_11";
			if (transactionsList.contains("NewQuote")) {
			...
			// UNDERLYING POLICY 3 CUWC_11 NEW QUOTE TRANSACTION
			strRegressionIDUnderlined = "CUWC_11";
			if (transactionsList.contains("NewQuote")) {
				transaction = "NewQuote";String suspendSheet = ExcelOperations.getPageToBeSuspended(strRegressionID,transaction);
			/*	LoginPage.APAppLogin(strRegressionIDUnderlined,   transaction,"No", test);
				quote=APPW_CommonMethods.getQuoteNumber(strRegressionIDUnderlined,test);*/
			...
			// COMMERCIAL UMBRELLA CU_12 NEW QUOTE TRANSACTION
			if (transactionsList.contains("NewQuote")) {
				transaction = "NewQuote";
				String suspendSheet = ExcelOperations.getPageToBeSuspended(strRegressionID,transaction);
				//LoginPage.APAppLogin(strRegressionIDUnderlined,   transaction,"No", test);
			...
			if (transactionsList.contains("BookPolicyInPW")) {
				strRegressionIDUnderlined = "CUBP_14";
				LoginPage.APAppLogin(strRegressionIDUnderlined,   transaction,"No", test);
			...
			e.printStackTrace();
			se.verify().verifyEquals("CU12_WI_CURegression test  failed", true, false, true, test);
