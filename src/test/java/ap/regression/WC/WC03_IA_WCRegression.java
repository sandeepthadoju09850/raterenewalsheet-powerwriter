...
public class WC03_IA_WCRegression extends BaseTest {
	...
	public static void WC03_IA_WCRegressionMethod(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,String strRegressionName, File file,XSSFWorkbook workbook, ExtentTest test) throws IOException {
		{
			...
			try {
				...
				e.printStackTrace();
				se.verify().verifyEquals("WC03_IA_WCRegression test  failed", true, false, true, test);
