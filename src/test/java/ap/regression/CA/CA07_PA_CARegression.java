...
public class CA07_PA_CARegression extends BaseTest{
	...
	public static void CA07_PA_CARegressionMethod(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,String strRegressionName, File file,XSSFWorkbook workbook, ExtentTest test) throws IOException {
		{
