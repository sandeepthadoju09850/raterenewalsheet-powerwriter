...
public class Functional_03_GL_ClassDefaults_01_ElectricalWiring extends BaseTest{
	...
	public static void GL_ClassDefaults_01_ElectricalWiring(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,File file,XSSFWorkbook workbook, ExtentTest test) throws IOException {
		{
			...
			try {
				...
				e.printStackTrace();
				se.verify().verifyEquals("Functional_03_GL_ClassDefaults_01_ElectricalWiring test failed", true, false, true, test);
