...
public class BP04_ND_BPRegression extends BaseTest{
	...
	public static void BP04_ND_BPRegressionMethod(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,String strRegressionName, File file,XSSFWorkbook workbook, ExtentTest test) throws IOException {
		{
			...
			try {
				...
				e.printStackTrace();
				se.verify().verifyEquals("BP04_ND_BPRegression test  failed", true, false, true, test);
