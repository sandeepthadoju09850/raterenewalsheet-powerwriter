...
public class WC_PolicyInformation extends BL_OR_CP {
	public void WC_PolicyInformation_Details(String strRegressionID, String transaction,String suspendSheet,  ExtentTest test) throws IOException
	{
		...
		List<Map<String, String>> table = ExcelOperations.getBLPagesData(constants.PolicyInformation, strRegressionID, transaction);
		int iteration = 0;
