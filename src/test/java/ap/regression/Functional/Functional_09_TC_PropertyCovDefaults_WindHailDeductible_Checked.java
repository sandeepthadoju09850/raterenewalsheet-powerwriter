...
public class Functional_09_TC_PropertyCovDefaults_WindHailDeductible_Checked extends BaseTest{
	...
	public static void TC_PropertyCovDefaults_WindHailDeductible_Checked(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,String strRegressionName, File file,XSSFWorkbook workbook, ExtentTest test) throws IOException {
		{
			...
			try {
				...
				e.printStackTrace();
				se.verify().verifyEquals("Functional_09_TC_PropertyCovDefaults_WindHailDeductible_Checked test failed", true, false, true, test);
