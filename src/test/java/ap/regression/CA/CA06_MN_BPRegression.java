...
public class CA06_MN_BPRegression extends BaseTest{
	...
	public static void CABP06_MN_RegressionMethod(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,String strRegressionName, File file,XSSFWorkbook workbook, ExtentTest test) throws IOException {
		{
			...
			try {
				...
				String strRegressionIDUnderlined = "CABP_06";
				...
				List<Map<String, String>> table = ExcelOperations.getPagesData(constants.loginPageName, strRegressionID,transaction);
					...
					strRegressionIDUnderlined = "CA_06";
					if (transactionsList.contains("NewQuote")) {
