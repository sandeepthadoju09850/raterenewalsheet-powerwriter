...
public class Functional_29_CA_TC_Fleet extends BaseTest{
	...
	public static void CA_TC_Fleet(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,String strRegressionName, File file,XSSFWorkbook workbook, ExtentTest test) throws IOException {
		{
			...
			try {
				...
				e.printStackTrace();
				se.verify().verifyEquals("Functional_29_CA_TC_Fleet test failed", true, false, true, test);
