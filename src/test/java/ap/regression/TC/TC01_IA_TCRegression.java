...
public class TC01_IA_TCRegression extends BaseTest{
	...
	public static void TC01_IA_TCRegressionMethod(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,String strRegressionName, File file,XSSFWorkbook workbook, ExtentTest test) throws IOException {
		{
			...
			try {
				...
				while (iteration < table.size()) {
					...
					if (transactionsList.contains("RedoNewQuoteOne")) {
						...
						APPW_CommonMethods.refreshWhen502error("TC_01 RedoNewQuoteOne summary ", 2,  test);
				...
				e.printStackTrace();
				se.verify().verifyEquals("TC_01_IA_TCRegression test  failed", true, false, true, test);
