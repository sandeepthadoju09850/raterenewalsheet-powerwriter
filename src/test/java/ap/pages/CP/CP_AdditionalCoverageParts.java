...
public class CP_AdditionalCoverageParts extends OR_CP {
	...
	public void CP_AdditionalCoverageParts_Details(String strRegressionID, String transaction, String suspendSheet, ExtentTest test) throws IOException
	{
		...
		List<Map<String, String>> table = ExcelOperations.getPagesData(constants.Additional_Coverage_Parts, strRegressionID, transaction);
		int iteration = 0;
