...
public class WC_RatingClassifications extends BL_OR_CP {
	public void WC_RatingClassifications_Details(String strRegressionID, String transaction,String suspendSheet,  ExtentTest test) throws IOException
	{
		...
		List<Map<String, String>> table = ExcelOperations.getBLPagesData(constants.RatingClassifications, strRegressionID, transaction);
		int iteration = 0;
