...
public class TC03_MO_TCRegression extends BaseTest{
	...
	public static void TC03_MO_TCRegressionMethod(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,String strRegressionName, File file,XSSFWorkbook workbook, ExtentTest test) throws IOException {
		{
			...
			try {
				...
				e.printStackTrace();
				se.verify().verifyEquals("TC_03_MO_TCRegression test  failed", true, false, true, test);
