...
public class BP06_IL_BPRegression extends BaseTest{
	...
	public static void BP06_IL_BPRegressionMethod(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,String strRegressionName, File file,XSSFWorkbook workbook, ExtentTest test) throws IOException {
		{
...
//List<Map<String, String>> table = ExcelOperations.getPagesData(constants.loginPageName, strRegressionID,transaction);
				...
				e.printStackTrace();
				se.verify().verifyEquals("BP06_IL_BPRegression test  failed", true, false, true, test);
