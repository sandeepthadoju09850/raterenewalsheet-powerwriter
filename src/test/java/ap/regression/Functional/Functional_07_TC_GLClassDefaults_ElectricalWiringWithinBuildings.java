...
public class Functional_07_TC_GLClassDefaults_ElectricalWiringWithinBuildings extends BaseTest{
	...
	public static void TC_GLClassDefaults_ElectricalWiringWithinBuildings(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,String strRegressionName, File file,XSSFWorkbook workbook, ExtentTest test) throws IOException {
		{
			...
			try {
				...
				while (iteration < table.size()) {
					...
					if (transactionsList.contains("NewQuote")) {
						...
						APPW_CommonMethods.Verify(test,"LiabilityAdditionalInterests","//h3[contains(text(),'Liability Additional Interests')]");
				...
				e.printStackTrace();
				se.verify().verifyEquals("Functional_07_TC_GLClassDefaults_ElectricalWiringWithinBuildings test failed", true, false, true, test);
