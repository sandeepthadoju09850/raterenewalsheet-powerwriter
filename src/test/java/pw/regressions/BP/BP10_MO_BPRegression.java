...
public class BP10_MO_BPRegression extends BaseTest{
	
	ExtentReports extent;
	ExtentTest test;

	
	public static void MO_BPRegressionMethod(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,File file,XSSFWorkbook workbook, ExtentTest test) throws IOException {
		...
		CP_FungusWet FungusWetPage = TestPageFactory.initElements(se, CP_FungusWet.class);
		...
		try {
			...
			String transaction = "NewQuote";
				  ...
				  FungusWetPage.FungusWet(strRegressionID, transaction, test);
			...
			if(transactionsList.contains("ConvertQFRToPolicy")){
				...
				e.printStackTrace();
				se.verify().verifyEquals("MO_BPRegression test  failed", true, false);
				testTearDown(se);
			}
