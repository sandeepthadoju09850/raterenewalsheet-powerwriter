...
public class Common_CloseSubmission extends OR_CP {
	...
	public void Common_CloseSubmission_Details(String strRegressionID, String transaction,String suspendSheet,  ExtentTest test) throws IOException
	{
		...
		List<Map<String, String>> table = ExcelOperations.getPagesData(constants.CloseSub, strRegressionID, transaction);
		int iteration = 0;
