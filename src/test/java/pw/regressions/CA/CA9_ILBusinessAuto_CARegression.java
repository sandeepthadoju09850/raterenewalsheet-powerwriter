...
import pw.pages.CA.CA_LossOfUseExpenses;
...
public class CA9_ILBusinessAuto_CARegression extends BaseTest{

	ExtentReports extent;
	ExtentTest test;
		
	public static void ILBusinessAuto_CARegressionMethod(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,File file,XSSFWorkbook workbook, ExtentTest test) throws IOException {
		...
		CA_LossOfUseExpenses CA_LossOfUseExpenses = TestPageFactory.initElements(se, CA_LossOfUseExpenses.class);
		...
		try {
			...
			if (transactionsList.contains("NewQuote")) {
				...
				CommonMethods.NavigateTo("Loss of Use Expenses - Rental Vehicles - Optional Limits",test);
				CA_LossOfUseExpenses.LossOfUseExpenses(strRegressionID, transaction, suspendSheet, test);
			...
			e.printStackTrace();
			se.verify().verifyEquals("ILBusinessAutoRegression test  failed", true, false);
			testTearDown(se);
		}
	}
