...
public class TC07_KY_TCRegression extends BaseTest{
	...
	public static void TC07_KY_TCRegressionMethod(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,String strRegressionName, File file,XSSFWorkbook workbook, ExtentTest test) throws IOException {
		{
