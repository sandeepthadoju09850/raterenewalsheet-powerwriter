...
public class Functional_01_CA_MelissaLookupPartialMatch extends BaseTest{
	...
	public static void CA_MelissaLookupPartialMatch(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,String strRegressionName, File file,XSSFWorkbook workbook, ExtentTest test) throws IOException {
		{
