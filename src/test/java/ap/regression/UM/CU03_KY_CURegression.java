...
public class CU03_KY_CURegression extends BaseTest{
	...
	public static void CU03_KY_CURegressionMethod(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,String strRegressionName, File file,XSSFWorkbook workbook, ExtentTest test) throws IOException 
	{
		...
		try {
			...
			String strRegressionIDUnderlined = "CUTC_07";
			...
			//String randomNumber = Integer.toString(se.util().randomnumber());
			// UNDERLYING POLICY 1 CUTC_07 NEW QUOTE TRANSACTION
			if (transactionsList.contains("NewQuote")) {
				...
				CP_AccountClearance.CP_AccountClearance_Details(strRegressionIDUnderlined, transaction, suspendSheet, strAgentLinkTC, strLOB, strRelease_SelectRelease, strRole_SelectRoleAs, test);
			...
			// UNDERLYING POLICY 2 CUCA_03 - CA 3 
			strRegressionIDUnderlined = "CUCA_03";
			...
			if (transactionsList.contains("BookPolicyInPW")) {
				...
				strRegressionIDUnderlined = "CUTC_07";
				LoginPage.APAppLogin(strRegressionIDUnderlined,   transaction,"No", test);
			...
			// Policy Issuance of Underlying Quote (KY TC)
