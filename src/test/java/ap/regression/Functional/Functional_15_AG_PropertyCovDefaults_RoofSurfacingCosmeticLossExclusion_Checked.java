...
public class Functional_15_AG_PropertyCovDefaults_RoofSurfacingCosmeticLossExclusion_Checked extends BaseTest{
	...
	public static void AG_PropertyCovDefaults_RoofSurfacingCosmeticLossExclusion_Checked(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,String strRegressionName, File file,XSSFWorkbook workbook, ExtentTest test) throws IOException {
		{
			...
			try {
				...
				e.printStackTrace();
				se.verify().verifyEquals("Functional_15_AG_PropertyCovDefaults_RoofSurfacingCosmeticLossExclusion_Checked test failed", true, false, true, test);
