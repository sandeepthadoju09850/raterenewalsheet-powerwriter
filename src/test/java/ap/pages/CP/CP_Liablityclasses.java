...
public class CP_Liablityclasses extends OR_CP{
	public void CP_Liablityclasses_Details(String strRegressionID, String transaction,String suspendSheet,  ExtentTest test) throws IOException
	{
		...
		List<Map<String, String>> table = ExcelOperations.getPagesData(constants.Liability_Classes, strRegressionID, transaction);
		int iteration = 0;
