...
public class CP_ContractorsEquipmentScheduled extends OR_CP {
	public void CP_ContractorsEquipmentScheduled_Details(String strRegressionID, String transaction,String suspendSheet,  ExtentTest test) throws IOException
	{
		...
		List<Map<String, String>> table = ExcelOperations.getPagesData(constants.ContractorsEquipmentScheduled, strRegressionID, transaction);
		int iteration = 0;
