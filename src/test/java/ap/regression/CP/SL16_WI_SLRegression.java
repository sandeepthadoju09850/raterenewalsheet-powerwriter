...
public class SL16_WI_SLRegression extends BaseTest{
	...
	public static void SL16_WI_SLRegressionMethod(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,String strRegressionName, File file,XSSFWorkbook workbook, ExtentTest test) throws IOException {
		{
			...
			try {
				...
				e.printStackTrace();
				se.verify().verifyEquals("SL16_WI_SLRegression test  failed", true, false, true, test);
