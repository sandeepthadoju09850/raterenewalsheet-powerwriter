...
public class SL12_PA_SLRegression extends BaseTest{
	...
	public static void SL12_PA_SLRegressionMethod(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,String strRegressionName, File file,XSSFWorkbook workbook, ExtentTest test) throws IOException 
	{
