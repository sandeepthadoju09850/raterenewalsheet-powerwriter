...
public class BP4_IL_BPRegression extends BaseTest {
	ExtentReports extent;
	ExtentTest test;

	
	public static void IL_BPRegressionMethod(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,File file,XSSFWorkbook workbook, ExtentTest test) throws IOException {
		...
		try {
			...
			if(transactionsList.contains("ConvertQFRToPolicy")){
				...
				e.printStackTrace();
				se.verify().verifyEquals("IL BP Regression test  failed", true, false);
				testTearDown(se);
			}
