...
public class WC06_PA_BPRegression extends BaseTest{
	...
	public static void WCBP06_PA_RegressionMethod(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,String strRegressionName, File file,XSSFWorkbook workbook, ExtentTest test) throws IOException {
		{
			...
			try {
				...
				String strRegressionIDUnderlined = "WC_06";
				...
				List<Map<String, String>> table = ExcelOperations.getPagesData(constants.loginPageName, strRegressionID,transaction);
					...
					strRegressionIDUnderlined = "WCBP_06";
					if (transactionsList.contains("NewQuote")) {
						transaction = "NewQuote";String suspendSheet = ExcelOperations.getPageToBeSuspended(strRegressionID,transaction);
				...
				e.printStackTrace();
				se.verify().verifyEquals("WC06_PA_BPRegression test  failed", true, false, true, test);
