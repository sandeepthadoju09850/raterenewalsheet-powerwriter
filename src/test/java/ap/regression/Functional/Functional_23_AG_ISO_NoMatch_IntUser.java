...
public class Functional_23_AG_ISO_NoMatch_IntUser extends BaseTest{
	...
	public static void AG_ISO_NoMatch_IntUser(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,String strRegressionName, File file,XSSFWorkbook workbook, ExtentTest test) throws IOException {
		{
			...
			try {
				...
				while (iteration < table.size()) {
					...
					if (transactionsList.contains("NewQuote2")) {
						transaction = "NewQuote2";
						String suspendSheet = ExcelOperations.getPageToBeSuspended(strRegressionID,transaction);
				...
				e.printStackTrace();
				se.verify().verifyEquals("Functional_23_AG_ISO_NoMatch_IntUser test failed", true, false, true, test);
