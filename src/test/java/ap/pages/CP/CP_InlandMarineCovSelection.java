...
public class CP_InlandMarineCovSelection extends BL_OR_CP{
	public void CP_InlandMarineCovSelection_Details(String strRegressionID, String transaction,String suspendSheet,  ExtentTest test) throws IOException
	{
		...
		List<Map<String, String>> table = ExcelOperations.getBLPagesData(constants.Inlnd_Marine_Coverage_Selection, strRegressionID, transaction);
		int iteration = 0;
