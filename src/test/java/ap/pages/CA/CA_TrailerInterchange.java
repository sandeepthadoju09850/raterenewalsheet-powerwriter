...
public class CA_TrailerInterchange extends BL_OR_CP  {
	...
	public void CA_TrailerInterchange_Details(String strRegressionID, String transaction,String suspendSheet,  ExtentTest test) throws IOException
	{
		...
		List<Map<String, String>> table = ExcelOperations.getBLPagesData(constants.TrailerInterchange, strRegressionID, transaction);
		int iteration = 0;
