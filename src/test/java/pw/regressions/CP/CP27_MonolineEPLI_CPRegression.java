...
public class CP27_MonolineEPLI_CPRegression extends BaseTest {
	ExtentReports extent;
	ExtentTest test;
	
	
	public static void MonolineEPLICPRegressionMethod(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,File file,XSSFWorkbook workbook, ExtentTest test) throws IOException {
		...
		CP_EmploymentPracticesLiabilityInsurancePage EmploymentPracticesLiability = TestPageFactory.initElements(se, CP_EmploymentPracticesLiabilityInsurancePage.class);
		...
		try {
			...
			EmploymentPracticesLiability.CP_EmployPracLiabInsPage(strRegressionID,transaction,test);
			...
			e.printStackTrace();
			se.verify().verifyEquals("EPLICpRegression test  failed", true, false);
			testTearDown(se);
		}
	}
