...
public class Functional_05_GL_ClassDefaults_03_BasketBallLeagues extends BaseTest{
	...
	public static void GL_ClassDefaults_03_BasketBallLeagues(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,File file,XSSFWorkbook workbook, ExtentTest test) throws IOException {
		{
			...
			try {
				...
				e.printStackTrace();
				se.verify().verifyEquals("Functional_05_GL_ClassDefaults_03_BasketBallLeagues test failed", true, false, true, test);
