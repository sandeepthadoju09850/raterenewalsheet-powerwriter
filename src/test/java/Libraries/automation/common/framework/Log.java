...
public class Log {
	...
	public void setTcStartTime() {
		tcStartTime = Libraries.automation.common.framework.Util
				.getDateStamp(Libraries.automation.common.framework.Util.ISO8601_DATETIMESTAMP);
	}
	...
	public void setTcEndTime() {
		tcEndTime = Libraries.automation.common.framework.Util
				.getDateStamp(Libraries.automation.common.framework.Util.ISO8601_DATETIMESTAMP);
	}
	...
	public void logSeStep(String step) {
		// get current date
		String timeStamp = Libraries.automation.common.framework.Util
				.getDateStamp(Libraries.automation.common.framework.Util.ISO8601_TIMESTAMP);
