...
public class TC13_MNServiceCenter_TCRegression extends BaseTest{
	...
	public static void TC13_MNServiceCenter_TCRegressionMethod(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,String strRegressionName, File file,XSSFWorkbook workbook, ExtentTest test) throws IOException {
		{
			...
			try {
				...
				e.printStackTrace();
				se.verify().verifyEquals("TC13_MN_TCRegression test  failed", true, false, true, test);
