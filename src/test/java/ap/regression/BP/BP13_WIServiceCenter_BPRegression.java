...
public class BP13_WIServiceCenter_BPRegression extends BaseTest{
	...
	public static void BP13_WIServiceCenter_BPRegressionMethod(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,String strRegressionName, File file,XSSFWorkbook workbook, ExtentTest test) throws IOException {
		{
			...
			try {
				...
				while (iteration < table.size()) {
				   ...
				   if (transactionsList.contains("BookPolicyInPW")) {
						...
						APPW_CommonMethods.getDashboardActions(strRegressionID, "PWConvertToPolicy", suspendSheet, test);test.log(LogStatus.INFO, "PW Elapsed Time", "<b>Started Time : "+PWstartTime+"<br> <b>Ended Time : "+Util.getTime()+"<br> <b>Time Taken : "+Util.DiffInTime(PWstartTime, Util.getTime())); 
				...
				e.printStackTrace();
				se.verify().verifyEquals("BP_08_WI_BPRegression test  failed", true, false, true, test);
