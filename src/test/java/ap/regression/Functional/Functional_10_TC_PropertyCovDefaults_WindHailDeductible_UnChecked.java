...
public class Functional_10_TC_PropertyCovDefaults_WindHailDeductible_UnChecked extends BaseTest{
	...
	public static void TC_PropertyCovDefaults_WindHailDeductible_UnChecked(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,String strRegressionName, File file,XSSFWorkbook workbook, ExtentTest test) throws IOException {
		{
			...
			try {
				...
				e.printStackTrace();
				se.verify().verifyEquals("Functional_10_TC_PropertyCovDefaults_WindHailDeductible_UnChecked test failed", true, false, true, test);
