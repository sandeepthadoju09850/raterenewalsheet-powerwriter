...
public class CU18_CO_CURegression extends BaseTest{
	ExtentReports extent;
	ExtentTest test;
	static String PolicyNumberCU = "";
	static String PolicyNumberSL = "";
	static String PolicyNumberCA = "";
	static String PolicyNumberWC = "";
	static String quote;

	@SuppressWarnings("unused")
	public static void CU08_CO_CURegressionMethod(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,String strRegressionName, File file,XSSFWorkbook workbook, ExtentTest test) throws IOException 
	{
		...
		try {
			...
			String strRegressionIDUnderlined = "CUSL_10";
			List<String> transactionsList = ExcelOperations.getTransactionsList(strRegressionID);
			List<Map<String, String>> table = ExcelOperations.getPagesData(constants.loginPageName, strRegressionIDUnderlined,transaction);
			...
			List<Map<String, String>> tableCU = ExcelOperations.getPagesData(constants.loginPageName, strRegressionID,transaction);
			LinkedHashMap<String, String> rowCU = (LinkedHashMap<String, String>) tableCU.get(0);
			String strAgentLinkCU = (String) rowCU.get("AgentLink");
			...
			if (transactionsList.contains("NewQuote")) {
				...
				CP_Summary.CP_Summary_Details(strRegressionIDUnderlined,strRegressionName, transaction, suspendSheet, strAgentLink, "Package", strRelease_SelectRelease, strRole_SelectRoleAs,quote, test, file,  workbook);
			}
			

			// UNDERLYING POLICY 2 CUCA_06 - CA 6 
			strRegressionIDUnderlined = "CUCA_16";
			...
			if (transactionsList.contains("NewQuote")) {
				...
				CP_GenInfo.CP_GenInfo_Details(strRegressionIDUnderlined, transaction, suspendSheet, strAgentLinkCU, "Umbrella", strRelease_SelectRelease, strRole_SelectRoleAs, test);
				CP_ExtendedNamedInsured.CP_ExtendedNamedInsured_Details(strRegressionIDUnderlined, transaction, suspendSheet, strAgentLinkCU,strLOB,strRelease_SelectRelease,strRole_SelectRoleAs, test);
				CP_Locations.CP_Locations_Details(strRegressionIDUnderlined, transaction, suspendSheet, strAgentLink,strLOB,strRelease_SelectRelease,strRole_SelectRoleAs, test);
				quote=APPW_CommonMethods.getQuoteNumber(strRegressionIDUnderlined,test);
				...
				CP_PremiumIndication.CP_PremiumIndication_Details(strRegressionIDUnderlined, transaction, suspendSheet, test);
				BT.ClickContinue(test);
				CA_PremiumModification.CA_PremiumModification_Details(strRegressionIDUnderlined, transaction, suspendSheet, strAgentLinkCU, strLOB, strRelease_SelectRelease, strRole_SelectRoleAs, test);
				...
				BT.ClickContinue(test);
				CP_BillingInformation.CP_BillingInformation_Details(strRegressionIDUnderlined, transaction, suspendSheet, test);
				CP_Summary.CP_Summary_Details(strRegressionIDUnderlined,strRegressionName, transaction, suspendSheet, strAgentLinkCU, "Commercial Auto", strRelease_SelectRelease, strRole_SelectRoleAs,quote, test, file,  workbook);
				//LoginPage.APLogoutDetails( strAgentLinkCU,test );

			}

			strRegressionIDUnderlined = "CUWC_16";
			if (transactionsList.contains("NewQuote")) {
				transaction = "NewQuote";String suspendSheet = ExcelOperations.getPageToBeSuspended(strRegressionID,transaction);
				/*LoginPage.APAppLogin(strRegressionIDUnderlined,   transaction,"No", test);
				APPW_CommonMethods.openQuoteInAP(quote,"N/A",test);*/
				...
				CP_GenInfo.CP_GenInfo_Details(strRegressionIDUnderlined, transaction, suspendSheet, strAgentLinkCU, "Umbrella", strRelease_SelectRelease, strRole_SelectRoleAs, test);
				//CP_AccountClearance.CP_AccountClearance_Details(strRegressionIDUnderlined, transaction, suspendSheet, strAgentLinkCU, strLOB, strRelease_SelectRelease, strRole_SelectRoleAs, test);
				CP_ExtendedNamedInsured.CP_ExtendedNamedInsured_Details(strRegressionIDUnderlined, transaction, suspendSheet, strAgentLinkCU,strLOB,strRelease_SelectRelease,strRole_SelectRoleAs, test);
				CP_Locations.CP_Locations_Details(strRegressionIDUnderlined, transaction, suspendSheet, strAgentLink,strLOB,strRelease_SelectRelease,strRole_SelectRoleAs, test);
				quote=APPW_CommonMethods.getQuoteNumber(strRegressionIDUnderlined,test);
			...
			if (transactionsList.contains("RedoNewQuote")) {
				...
				CP_CarrierInformation.CP_CarrierInformation_Details(strRegressionIDUnderlined, transaction, suspendSheet, test);
				CP_BillingInformation.CP_BillingInformation_Details(strRegressionIDUnderlined, transaction, suspendSheet, test);
				CP_Summary.CP_Summary_Details(strRegressionIDUnderlined,strRegressionName, transaction, suspendSheet, strAgentLinkCU, "Workers", strRelease_SelectRelease, strRole_SelectRoleAs,quote, test, file,  workbook);
				//LoginPage.APLogoutDetails( strAgentLinkCU,test );
			...
			if (transactionsList.contains("NewQuote")) {
				...
				CP_Summary.CP_Summary_Details(strRegressionID,strRegressionName, transaction, suspendSheet, strAgentLinkCU, "Umbrella", strRelease_SelectRelease, strRole_SelectRoleAs,quote, test, file,  workbook);
			...
			if (transactionsList.contains("BookPolicyInPW")) {
				strRegressionIDUnderlined = "CUSL_10";
				LoginPage.APAppLogin(strRegressionIDUnderlined,   transaction,"No", test);
				...
				PolicyNumberSL = APPW_CommonMethods.retrievePolicyNumber(test);
				CP_Summary.CP_Summary_Details(strRegressionID,strRegressionName, transaction, suspendSheet, strAgentLink, "N/A", strRelease_SelectRelease, strRole_SelectRoleAs,PolicyNumberSL, test, file,  workbook);
			...
			if (transactionsList.contains("PolicyIssuanceOnAP")) {
				...
				se.util().sleep(60000);
				LoginPage.APAppLogin(strRegressionIDUnderlined,   transaction,"No", test);
				APPW_CommonMethods.APSearchPolicyNumber(PolicyNumberSL,test);
				CP_Summary.CP_Summary_Details(strRegressionIDUnderlined,strRegressionName, transaction, suspendSheet, strAgentLink, "Package", strRelease_SelectRelease, strRole_SelectRoleAs,PolicyNumberSL, test, file,  workbook);
			...
			e.printStackTrace();
			se.verify().verifyEquals("CU18_CO_CURegression test  failed", true, false, true, test);
