...
public class SL02_IA_SLRegression extends BaseTest{
	...
	public static void SL02_IA_SLRegressionMethod(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,String strRegressionName, File file,XSSFWorkbook workbook, ExtentTest test) throws IOException 
	{
		...
		CP_ScheduledProperty CP_ScheduledProperty = TestPageFactory.initElements(se, CP_ScheduledProperty.class);
			...
			e.printStackTrace();
			se.verify().verifyEquals("SL02_IA_SLRegression test  failed", true, false, true, test);
