...
public class WC_OtherStateInsurance extends OR_CP {
	public void WC_OtherStateInsurance_Details(String strRegressionID, String transaction,String suspendSheet,  ExtentTest test) throws IOException
	{
		...
		List<Map<String, String>> table = ExcelOperations.getPagesData(constants.WC_OtherStateInsurance, strRegressionID, transaction);
		int iteration = 0;
