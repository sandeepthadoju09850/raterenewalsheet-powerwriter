...
public class CA03_KY_CARegression extends BaseTest{
	...
	public static void CA03_KY_CARegressionMethod(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,String strRegressionName, File file,XSSFWorkbook workbook, ExtentTest test) throws IOException {
		{
			...
			try {
				...
				e.printStackTrace();
				se.verify().verifyEquals("CA03_KY_CARegression test  failed", true, false, true, test);
