...
public class Functional_11_AG_PropertyCovDefaults_RoofSurfacingActualCashValue_Checked extends BaseTest{
	...
	public static void AG_PropertyCovDefaults_RoofSurfacingActualCashValue_Checked(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,String strRegressionName, File file,XSSFWorkbook workbook, ExtentTest test) throws IOException {
		{
			...
			try {
				...
				while (iteration < table.size()) {
					...
					if (transactionsList.contains("NewQuote")) {
						...
						BT.ClickContinue(test); // Navigating to Liability Coverages page
						BT.ClickContinue(test); // Navigating to Liability Classes page
						...
						BT.ClickContinue(test); //Navigating to Premium Indication screen
						...
						BT.ClickContinue(test); //Navigating to Underwriting Questions screen
						...
						BT.ClickContinue(test); //Navigating to Billing Information page
				...
				e.printStackTrace();
				se.verify().verifyEquals("Functional_11_AG_PropertyCovDefaults_RoofSurfacingActualCashValue_Checked test failed", true, false, true, test);
