...
public class CA32_WIFarmAutoNonFleet_CARegression extends BaseTest{

	ExtentReports extent;
	ExtentTest test;
		
	public static void WIFarmAutoNonFleet_CARegressionMethod(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,File file,XSSFWorkbook workbook, ExtentTest test) throws IOException {
		...
		try {
			...
			e.printStackTrace();
			se.verify().verifyEquals("WIFarmAutoNonFleet_CARegression test  failed", true, false);
			testTearDown(se);
		}
	}
