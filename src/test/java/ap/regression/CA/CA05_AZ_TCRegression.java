...
public class CA05_AZ_TCRegression extends BaseTest{
	...
	public static void CATC05_AZ_RegressionMethod(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,String strRegressionName, File file,XSSFWorkbook workbook, ExtentTest test) throws IOException {
		{
			...
			try {
				...
				String strRegressionIDUnderlined = "CATC_05";
				...
				List<Map<String, String>> table = ExcelOperations.getPagesData(constants.loginPageName, strRegressionID,transaction);
					...
					strRegressionIDUnderlined = "CA_05";
					if (transactionsList.contains("NewQuote")) {
