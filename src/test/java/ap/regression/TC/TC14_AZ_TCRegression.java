...
public class TC14_AZ_TCRegression extends BaseTest{
	...
	public static void TC14_AZ_TCRegressionMethod(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,String strRegressionName, File file,XSSFWorkbook workbook, ExtentTest test) throws IOException {
		{
			...
			try {
				...
				e.printStackTrace();
				se.verify().verifyEquals("TC14_AZ_TCRegression test  failed", true, false, true, test);
