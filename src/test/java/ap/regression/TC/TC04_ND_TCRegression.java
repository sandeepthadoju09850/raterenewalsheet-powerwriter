...
public class TC04_ND_TCRegression extends BaseTest{
	...
	public static void TC04_ND_TCRegressionMethod(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,String strRegressionName, File file,XSSFWorkbook workbook, ExtentTest test) throws IOException {
		{
			...
			try {
				...
				e.printStackTrace();
				se.verify().verifyEquals("TC_04_ND_TCRegression test  failed", true, false, true, test);
