...
public class CP_ValuablePapers extends BL_OR_CP {
	...
	public void CP_ValuablePapers_Details(String strRegressionID, String transaction,String suspendSheet,  ExtentTest test) throws IOException
	{
		...
		List<Map<String, String>> table = ExcelOperations.getBLPagesData(constants.ValuablePapers, strRegressionID, transaction);
		int iteration = 0;
