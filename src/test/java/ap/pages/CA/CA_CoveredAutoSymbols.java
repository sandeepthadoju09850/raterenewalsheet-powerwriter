...
public class CA_CoveredAutoSymbols extends OR_CP {
	public void CA_CoveredAutoSymbols_Details(String strRegressionID, String transaction,String suspendSheet,  ExtentTest test) throws IOException
	{
		...
		List<Map<String, String>> table = ExcelOperations.getPagesData(constants.CoveredAutoSymbols, strRegressionID, transaction);
		int iteration = 0;
