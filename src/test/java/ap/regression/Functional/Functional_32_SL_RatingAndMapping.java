...
public class Functional_32_SL_RatingAndMapping extends BaseTest{
	ExtentReports extent;
	ExtentTest test;
	static String quote;

	@SuppressWarnings("unused")
	public static void SL_RatingAndMapping(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,String strRegressionName, File file,XSSFWorkbook workbook, ExtentTest test) throws IOException {
		{
			...
			try {
				...
				while (iteration < table.size()) {
					...
					if (transactionsList.contains("NewQuote")) {
						...
						BT.ClickContinue(test);//Liability Options screen continue
				...
				e.printStackTrace();
				se.verify().verifyEquals("Functional_32_SL_RatingAndMapping test failed", true, false, true, test);
