...
public class CU19_KYServiceCenter_CURegression extends BaseTest{
	...
	public static void CU19_KYServiceCenter_CURegressionMethod(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,String strRegressionName, File file,XSSFWorkbook workbook, ExtentTest test) throws IOException 
	{
		...
		try {
			...
			String strRegressionIDUnderlined = "CUBP_18";
			...
			// UNDERLYING POLICY 1 CUBP_18 NEW QUOTE TRANSACTION
			...
			// UNDERLYING POLICY 1 CUBP_16 REDO TRANSACTION
			...
			// UNDERLYING POLICY 2 CUCA_13 NEW QUOTE TRANSACTION
			strRegressionIDUnderlined = "CUCA_17";
			...
			// UNDERLYING POLICY 3 CUWC_13 NEW QUOTE TRANSACTION
			strRegressionIDUnderlined = "CUWC_17";
			if (transactionsList.contains("NewQuote")) {
				transaction = "NewQuote";String suspendSheet = ExcelOperations.getPageToBeSuspended(strRegressionID,transaction);
				//LoginPage.APAppLogin(strRegressionIDUnderlined,   transaction,"No", test);
				APPW_CommonMethods.openQuoteInAP(quote,"N/A",test);
			...
			// COMMERCIAL UMBRELLA CU_19 NEW QUOTE TRANSACTION
			...
			if (transactionsList.contains("BookPolicyInPW")) {
				strRegressionIDUnderlined = "CUBP_18";
				LoginPage.APAppLogin(strRegressionIDUnderlined,   transaction,"No", test);
			...
			e.printStackTrace();
			se.verify().verifyEquals("CU19_KY_ServiceCenterCURegression test  failed", true, false, true, test);
