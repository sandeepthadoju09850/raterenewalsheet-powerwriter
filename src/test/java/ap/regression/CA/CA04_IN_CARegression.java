...
public class CA04_IN_CARegression extends BaseTest{
	...
	public static void CA04_IN_CARegressionMethod(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,String strRegressionName, File file,XSSFWorkbook workbook, ExtentTest test) throws IOException {
		{
			...
			try {
				...
				while (iteration < table.size()) {
					...
					if (transactionsList.contains("NewQuote")) {
						...
						CA_CoveredAutoSymbols.CA_CoveredAutoSymbols_Details(strRegressionID, transaction, suspendSheet,test);
				...
				e.printStackTrace();
				se.verify().verifyEquals("CA04_IN_CARegression test  failed", true, false, true, test);
