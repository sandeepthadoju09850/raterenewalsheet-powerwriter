...
public class SL06_MO_SLRegression extends BaseTest{
	...
	public static void SL06_MO_SLRegressionMethod(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,String strRegressionName, File file,XSSFWorkbook workbook, ExtentTest test) throws IOException 
	{
		...
		try {
			...
			while (iteration < table.size()) {
				...
				String strRelease_SelectRelease = (String) row.get("Select_Release");
					...
					if (transactionsList.contains("RedoNewQuote1")) {
						String transaction = "RedoNewQuote1";
						String suspendSheet = ExcelOperations.getPageToBeSuspended(strRegressionID,transaction);
			...
			e.printStackTrace();
			se.verify().verifyEquals("SL06_MO_SLRegression test  failed", true, false, true, test);
