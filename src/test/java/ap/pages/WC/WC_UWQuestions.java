...
public class WC_UWQuestions extends BL_OR_CP {
	public void WC_UnderWriter_Details(String strRegressionID, String transaction,String suspendSheet,  ExtentTest test) throws IOException
	{
		try{
		...
		while (iteration < table.size()) {
			...
			//String strUW_CHK_Withtheexception_Yes = (String) row.get("UW_CHK_Withtheexception_Yes");
			//String strUW_CHK_Withtheexception_No = (String) row.get("UW_CHK_Withtheexception_No");
			...
			//String strUW_TXT_Withtheexception_Explanation = (String) row.get("UW_TXT_Withtheexception_Explanation");
			...
			String strUW_CHK_AnyWorkPerformedunderground_Yes = (String) row.get("UW_CHK_AnyWorkPerformedunderground_Yes");
			String strUW_CHK_AnyWorkPerformedunderground_No = (String) row.get("UW_CHK_AnyWorkPerformedunderground_No");
			...
			String strUW_CHK_Anytowerwork_Yes = (String) row.get("UW_CHK_Anytowerwork_Yes");
			String strUW_CHK_Anytowerwork_No = (String) row.get("UW_CHK_Anytowerwork_No");
			...
			String strUW_CHK_AnyTreeTrimming_Yes = (String) row.get("UW_CHK_AnyTreeTrimming_Yes");
			String strUW_CHK_AnyTreeTrimming_No = (String) row.get("UW_CHK_AnyTreeTrimming_No");
			String strUW_CHK_DoesApplicantOwnOperate_Yes = (String) row.get("UW_CHK_DoesApplicantOwnOperate_Yes");
			String strUW_CHK_DoesApplicantOwnOperate_No = (String) row.get("UW_CHK_DoesApplicantOwnOperate_No");
			String strUW_CHK_AreEmployeeHealthPlansProvided_Yes = (String) row.get("UW_CHK_AreEmployeeHealthPlansProvided_Yes");
			String strUW_CHK_AreEmployeeHealthPlansProvided_No = (String) row.get("UW_CHK_AreEmployeeHealthPlansProvided_No");
			...
			try {
				...
				se.verify().verifyEquals("CP_UnderWriter_Details  of AgencyPortal ", getUnderWritterWC_label().isDisplayed(),true, true,test);
				...
				//se.element().checkUncheckOrValidate( getUW_CHK_Withtheexception_Yes(strUW_CHK_Withtheexception_Yes),strUW_CHK_Withtheexception_Yes,test);
				//se.element().checkUncheckOrValidate( getUW_CHK_Withtheexception_No(strUW_CHK_Withtheexception_No),strUW_CHK_Withtheexception_No,test);
				//se.element().enterOrValidateText( getUW_TXT_Withtheexception_Explanation(strUW_TXT_Withtheexception_Explanation),strUW_TXT_Withtheexception_Explanation,test);
				...
				se.element().checkUncheckOrValidate( getUW_CHK_AnyWorkPerformedunderground_Yes(strUW_CHK_AnyWorkPerformedunderground_Yes),strUW_CHK_AnyWorkPerformedunderground_Yes,test);
				se.element().checkUncheckOrValidate( getUW_CHK_AnyWorkPerformedunderground_No(strUW_CHK_AnyWorkPerformedunderground_No),strUW_CHK_AnyWorkPerformedunderground_No,test);
				...
				se.element().checkUncheckOrValidate( getUW_CHK_Anytowerwork_Yes(strUW_CHK_Anytowerwork_Yes),strUW_CHK_Anytowerwork_Yes,test);
				se.element().checkUncheckOrValidate( getUW_CHK_Anytowerwork_No(strUW_CHK_Anytowerwork_No),strUW_CHK_Anytowerwork_No,test);
				...
				se.element().checkUncheckOrValidate( getUW_CHK_AnyTreeTrimming_No(strUW_CHK_AnyTreeTrimming_No),strUW_CHK_AnyTreeTrimming_No,test);
				se.element().checkUncheckOrValidate( getUW_CHK_AnyTreeTrimming_Yes(strUW_CHK_AnyTreeTrimming_Yes),strUW_CHK_AnyTreeTrimming_Yes,test);
				se.element().checkUncheckOrValidate( getUW_CHK_DoesApplicantOwnOperate_Yes(strUW_CHK_DoesApplicantOwnOperate_Yes),strUW_CHK_DoesApplicantOwnOperate_Yes,test);
				se.element().checkUncheckOrValidate( getUW_CHK_DoesApplicantOwnOperate_No(strUW_CHK_DoesApplicantOwnOperate_No),strUW_CHK_DoesApplicantOwnOperate_No,test);
				se.element().checkUncheckOrValidate( getUW_CHK_AreEmployeeHealthPlansProvided_No(strUW_CHK_AreEmployeeHealthPlansProvided_No), strUW_CHK_AreEmployeeHealthPlansProvided_No,test);
				se.element().checkUncheckOrValidate( getUW_CHK_AreEmployeeHealthPlansProvided_Yes(strUW_CHK_AreEmployeeHealthPlansProvided_Yes), strUW_CHK_AreEmployeeHealthPlansProvided_Yes, test);
				...
				e.getMessage();
				e.printStackTrace();
				se.verify().verifyEquals("Failed to fill in details for WC_UnderWriter_Details ", true, false, true, test);
			}
			iteration++;
		}
}catch (Exception e) {
