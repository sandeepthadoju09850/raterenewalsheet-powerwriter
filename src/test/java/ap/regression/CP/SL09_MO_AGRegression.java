...
public class SL09_MO_AGRegression extends BaseTest{
	...
	public static void SL09_MO_AGRegressionMethod(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,String strRegressionName, File file,XSSFWorkbook workbook, ExtentTest test) throws IOException 
	{
		...
		try {
			...
			e.printStackTrace();
			se.verify().verifyEquals("SL09_MO_AGRegression test  failed", true, false, true, test);
