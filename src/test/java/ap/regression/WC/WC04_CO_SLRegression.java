...
public class WC04_CO_SLRegression extends BaseTest{
	...
	public static void WCSL04_CO_RegressionMethod(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,String strRegressionName, File file,XSSFWorkbook workbook, ExtentTest test) throws IOException {
		{
			...
			try {
				...
				String strRegressionIDUnderlined = "WCSL_04";
				...
				List<Map<String, String>> table = ExcelOperations.getPagesData(constants.loginPageName, strRegressionID,transaction);
					...
					if (transactionsList.contains("NewQuote")) {
						...
						CP_PremiumModification.CP_PremiumModification_Details(strRegressionIDUnderlined, transaction, suspendSheet, strAgentLink,strLOB,strRole_SelectRoleAs,strRelease_SelectRelease,quote, test);
					...
					strRegressionIDUnderlined = "WC_04";
					if (transactionsList.contains("NewQuote")) {
						transaction = "NewQuote";
						String suspendSheet = ExcelOperations.getPageToBeSuspended(strRegressionID,transaction);
				...
				e.printStackTrace();
				se.verify().verifyEquals("WC04_CO_SLRegression test  failed", true, false, true, test);
