...
public class CP_SignsScheduleInfo extends OR_CP {
	...
	public void CP_SignsScheduleInfo_Details(String strRegressionID, String transaction,String suspendSheet,  ExtentTest test) throws IOException
	{
		...
		List<Map<String, String>> table = ExcelOperations.getPagesData(constants.SignsScheduleInfo, strRegressionID, transaction);
		int iteration = 0;
