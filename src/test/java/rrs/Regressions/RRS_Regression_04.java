...
public class RRS_Regression_04 extends BaseTest {
	...
	*/
			...
			if(transactionsList.contains("BPReviseQuote")){
				...
				PWQuoteOpenPage.openPendingQuoteInPW(policyNumberPackage, controlDate,transaction,test);
			...
			if(transactionsList.contains("CAReviseQuote")){				
				...
				PWQuoteOpenPage.openPendingQuoteInPW(PolicyNumberCA, controlDate,transaction,test);	
				CommonMethods.NavigateTo("Commercial Auto",test);
			...
			if(transactionsList.contains("WCReviseQuote")){				
				...
				PWQuoteOpenPage.openPendingQuoteInPW(PolicyNumberWC, controlDate,transaction,test);	
				CommonMethods.NavigateTo("Locations (2)",test);
