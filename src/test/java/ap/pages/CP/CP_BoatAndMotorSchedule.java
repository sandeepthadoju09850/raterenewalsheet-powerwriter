...
public class CP_BoatAndMotorSchedule extends BL_OR_CP {
	...
	public void CP_BoatAndMotorSchedule_Details(String strRegressionID, String transaction,String suspendSheet,  ExtentTest test) throws IOException
	{
		...
		List<Map<String, String>> table = ExcelOperations.getBLPagesData(constants.BoatAndMotorSchedule, strRegressionID, transaction);
		int iteration = 0;
