...
public class WC_StateRatingFactors extends BL_OR_CP {
	public void WC_StateRatingFactors_Details(String strRegressionID, String transaction,String suspendSheet,  ExtentTest test) throws IOException
	{
		...
		List<Map<String, String>> table = ExcelOperations.getBLPagesData(constants.StateRatingFactors, strRegressionID, transaction);
		int iteration = 0;
