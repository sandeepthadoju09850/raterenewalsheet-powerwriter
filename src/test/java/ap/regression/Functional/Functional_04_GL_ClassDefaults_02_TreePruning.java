...
public class Functional_04_GL_ClassDefaults_02_TreePruning extends BaseTest{
	...
	public static void GL_ClassDefaults_02_TreePruning(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,File file,XSSFWorkbook workbook, ExtentTest test) throws IOException {
		{
			...
			try {
				...
				e.printStackTrace();
				se.verify().verifyEquals("Functional_04_GL_ClassDefaults_02_TreePruning test failed", true, false, true, test);
