...
public class AG02_IA_AGRegression extends BaseTest{
	...
	public static void AG02_IA_AGRegressionMethod(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,String strRegressionName, File file,XSSFWorkbook workbook, ExtentTest test) throws IOException 
	{
		...
		try {
			...
			e.printStackTrace();
			se.verify().verifyEquals("AG02_IA_AGRegression test  failed", true, false, true, test);
