...
public class CU13_CO_CURegression extends BaseTest{
	...
	public static void CU13_CO_CURegressionMethod(Browsers myBrowser, SeHelper se, Map<String, Object> params,String strRegressionID,String strRegressionName, File file,XSSFWorkbook workbook, ExtentTest test) throws IOException 
	{
		...
		try {
			...
			// UNDERLYING POLICY 3 CUWC_12 NEW QUOTE TRANSACTION
			...
			// COMMERCIAL UMBRELLA CU_13 NEW QUOTE TRANSACTION
			if (transactionsList.contains("NewQuote")) {
				transaction = "NewQuote";
				String suspendSheet = ExcelOperations.getPageToBeSuspended(strRegressionID,transaction);
				//LoginPage.APAppLogin(strRegressionIDUnderlined,   transaction,"No", test);
			...
			// Booking Underlying Quote (CO BP) in PW
			transaction = "BookPolicyInPW";
			String suspendSheet = ExcelOperations.getPageToBeSuspended(strRegressionID,transaction);
			
			if (transactionsList.contains("BookPolicyInPW")) {
				strRegressionIDUnderlined = "CUBP_15";
				LoginPage.APAppLogin(strRegressionIDUnderlined,   transaction,"No", test);
			...
			// Policy Issuance of Underlying Quote (CO BP)
			...
			// Policy Issuance of Underlying Quote (CO CA)
			if (transactionsList.contains("PolicyIssuanceOnAP")) {
				strRegressionIDUnderlined = "CUCA_12";
			...
			// Policy Issuance of Underlying Quote (CO WC)
			if (transactionsList.contains("PolicyIssuanceOnAP")) {
				strRegressionIDUnderlined = "CUWC_12";
