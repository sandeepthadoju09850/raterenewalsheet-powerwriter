...
public class CP_OptionalPropertyCoverages extends BL_OR_CP{
	public void CP_OptionalPropertyCoverages_Details(String strRegressionID, String transaction,String suspendSheet,  ExtentTest test) throws IOException
	{
		...
		List<Map<String, String>> table = ExcelOperations.getBLPagesData(constants.Optional_Property_Coverages, strRegressionID, transaction);
		int iteration = 0;
